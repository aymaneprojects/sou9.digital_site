...
const promoCodeSchema = z.object({
  ...
  (data) => {
    ...
    return data.startDate ? new Date(data.startDate) >= today : true;
  },
  {
  ...
  (data) => {
    const today = new Date();
    today.setHours(0, 0, 0, 0);
    return data.endDate ? new Date(data.endDate) >= today : true;
  },
  {
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {translate("admin.maxDiscount")} (MAD)
                      </FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                  ...
                  updatePromoCodeMutation.isPending ? (
                    ...
                    <>
                      ...
                      {selectedPromo
                        ...
                        : translate("admin.createPromoCode")}
                    </>
                  )}
                </Button>
              </DialogFooter>
